        ...
        for K_idx, K_func in enumerate(K_func_list):
            for horizon in horizons:
                ...
                for j, fixed_parameter in enumerate(fixed_parameter_list):
                    ...
                    np.savetxt("saved_estimations_univariate/horizons/" + str(horizon) + "univariate_horizon_" + str(K_func_name[K_idx]) + "_"+ fixed_list[j] + "_" + str(np.round(noise, 2)) + ".csv", estimations,
                               delimiter=",")